export const PRESET_ROUTES = {
  ...
  hoenn: [
    ...
    'Villa Raíz', 'Pueblo Escaso', 'Ciudad Petalia', 'Ciudad Férrica', 'Pueblo Azuliza', 'Ciudad Portual', 'Pueblo Verdegal', 'Ciudad Malvalona', 'Pueblo Pardal', 'Pueblo Lavacalda', 'Ciudad Arborada', 'Ciudad Calagua', 'Ciudad Algaria', 'Arrecípolis', 'Pueblo Oromar', 'Ciudad Colosalia',
    'Túnel Fervergal', 'Cueva Insular', 'Cueva Granito', 'Senda Ígnea', 'Desfiladero', 'Tumba Antigua', 'Guarida Aqua/Magma', 'Ruinas del Desierto', 'Monte Cenizo', 'Gruta Desértica', 'Cascada Meteoro', 'Monte Pírico', 'Cueva Cardumen', 'Caverna Abisal', 'Cueva Ancestral', 'Cueva Cambiante', 'Cueva Marina', 'Cueva Terrena', 'Gruta Solar', 'Cueva Taller',
